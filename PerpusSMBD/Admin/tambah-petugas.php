<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $insert = mysqli_query($connect, "CALL inputPetugas(
            '".$_POST['userName']."',
            '".$pass_md5."',
            '".$_POST['nm']."',
            '".$_POST['tlp']."',
            ...
            <tbody class="table-group-divider">
                <form action="" method="post">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="text" name="nm" class="form-control" placeholder="Nama Petugas" required>
                        </td>
                    </tr>
                    <tr>
                        <td>No. Handphone</td>
                        <td>:</td>
                        <td>
                            <input type="text" name="tlp" class="form-control" placeholder="Nomor HP" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>:</td>
                        <td>
                            <input type="text" name="almt" class="form-control" placeholder="Alamat Petugas" required>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
